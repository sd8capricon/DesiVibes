        ...
        <footer className="footer container-fluid bg-secondary text-dark mt-5 pt-5">
            <div className="row justify-content-center px-xl-5 pt-5">
                <div className="col-lg-4 col-md-12 mb-5 pe-3 pe-xl-5">
                    <a href="" className="title mb-5"><span>Desi</span>Vibes</a>
                    ...
                    <div className="row">
                        <div className="col-md-4 mb-5">
                            ...
                            <div className="d-flex flex-column justify-content-start">
                                <a className="text-dark mb-2" href="index.html"><i className="bi bi-caret-right-fill me-2"></i>Home</a>
                                <a className="text-dark mb-2" href="shop.html"><i className="bi bi-caret-right-fill me-2"></i>Our Shop</a>
                                <a className="text-dark mb-2" href="checkout.html"><i className="bi bi-caret-right-fill me-2"></i>Checkout</a>
                                <a className="text-dark" href="contact.html"><i className="bi bi-caret-right-fill me-2"></i>Contact Us</a>
                            </div>
                        </div>
